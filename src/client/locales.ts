...
export const zh = {
  ...
  terminal: '终端',
  editor: '编辑器',
  editorExplorer: '编辑器内嵌文件树',
  editorExplorerDesc: '选择编辑器标签页的形态：合并模式下头部是路径输入框，可开关的文件树面板支持全局文件名搜索，新会话默认打开空文件预览页（树面板展开）；独立模式恢复纯编辑器与独立资源管理器',
  editorExplorerMerged: '合并',
  editorExplorerMergedDesc: '文件预览内嵌可开关的文件树面板',
  editorExplorerSplit: '独立',
  editorExplorerSplitDesc: '文件预览与资源管理器各自独立标签页',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  terminal: 'Terminal',
  editor: 'Editor',
  editorExplorer: 'Embed the file tree in the editor',
  editorExplorerDesc: 'Pick the editor tab shape: merged mode puts a path input in the header with a toggleable file-tree panel (global file-name search) and seeds new conversations with an empty preview tab (tree open); separate mode restores the plain editor and the standalone explorer',
  editorExplorerMerged: 'Merged',
  editorExplorerMergedDesc: 'Dock a toggleable file-tree panel inside the file preview',
  editorExplorerSplit: 'Separate',
  editorExplorerSplitDesc: 'Keep the preview and the explorer as separate tabs',
